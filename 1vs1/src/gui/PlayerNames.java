...
public class PlayerNames extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\GhostBit\\Desktop\\git\\MAIN\\image\\smash-bros.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //get both name entered in the textbox and inserts a new entry to database
        String name1 = jTextField1.getText();
        String name2 = jTextField2.getText();
        ScoreR i = new ScoreR();
        i.insertR(name1, 0, name2, 0);
        playerScore a = new playerScore();
        a.jLabel1.setText(name1);
        a.jLabel2.setText(name2);
        a.id = i.getId();
